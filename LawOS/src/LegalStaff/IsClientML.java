			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					if(arr.getJSONObject(0).getString("COUNT(DISTINCT Flagged_ml)").equals("1")){
						JOptionPane.showMessageDialog(frame, "This client involved in money laudring!");
					}
					else{
						JOptionPane.showMessageDialog(frame, "This client didn't involve in money laudring!");
					}
