...
public class editApp {
	...
	private void initialize() {
		...
		JLabel lblEditAppointment = new JLabel("Edit Appointment");
		...
		JLabel label_6 = new JLabel("Recomandation");
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Form form = new Form();
				form.param("AppointmentID", appID_txt.getText());
				...
				if (res2.equals("1")){
					JOptionPane.showMessageDialog(frame, "Appointment Edited Successfully");
				}
				else{
		...
		JLabel lblEnterAppointmentid = new JLabel("<html>Enter appointmentID<br>\r\nto fill form:\r\n</htm>");
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					if(json.get("size").equals("0")){
						...
						case_txt.setText(arr.getJSONObject(0).getString("Case"));
